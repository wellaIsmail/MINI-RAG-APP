...
Revision ID: 6953c7ec659e
Revises: 
Create Date: 2025-06-12 23:17:38.407337
...
def upgrade() -> None:
    ...
    op.create_index('chunk_asset_id', 'chunks', ['chunk_asset_id'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index('chunk_asset_id', table_name='chunks')
